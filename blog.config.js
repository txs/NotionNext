...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || 'bb0bc25d3a55439abd6a885d7557bcae', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  // giscus評論插件 更多參考 https://giscus.app/
  COMMENT_GISCUS_REPO:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'tangly1024g/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'Repo_id', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY || 'Comments', // 你的Github Discussions 內的 Category 名稱 e.g 'Comments'
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'category_id', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
